...
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '5439499666').split()]
...
REQ_CHANNEL2=environ.get("REQ_CHANNEL2", "-1002332156682")
